...
public class ElytraHelper extends Module {
    ...
    private void setRotation(final LivingEntity base) {
        ...
        float newYaw = this.rotation.x + (deltaYaw > 0.0f ? additionYaw : -additionYaw) + ThreadLocalRandom.current().nextFloat(-1f, 1);
        float newPitch = this.rotation.y + (deltaPitch > 0.0f ? additionPitch : -additionPitch) + ThreadLocalRandom.current().nextFloat(-1f, 1);
